...
class TestEmployee(unittest.TestCase):
    ...
    def test_email(self):
        print('test_email')
        self.assertEqual(self.emp_1.email, 'Sriram.Murthy@boa.com')
        self.assertEqual(self.emp_2.email, 'Kavitha.Murthy@boa.com')

        self.emp_1.first = 'Kiran'
        self.emp_2.first = 'Raj'

        self.assertEqual(self.emp_1.email, 'Kiran.Murthy@boa.com')
        self.assertEqual(self.emp_2.email, 'Raj.Murthy@boa.com')
    ...
    def test_monthly_schedule(self):
        with patch('employee.requests.get') as mocked_get:
            ...
            mocked_get.assert_called_with('http://company.com/Murthy/May') #Murthy
            self.assertEqual(schedule, 'Success')

            mocked_get.return_value.ok = False

            schedule = self.emp_2.monthly_schedule('June')
            mocked_get.assert_called_with('http://company.com/Murthy/June') #Murthy
